...
namespace DRimEditor.Research
{
    ...
    public static class Assets
    {
        ...
        public static Texture2D SlightlyLightBackground =
            SolidColorMaterials.NewSolidColorTexture(0.5f, 0.5f, 0.5f, .1f);

        public static Texture2D LightBackground =
            SolidColorMaterials.NewSolidColorTexture(0.75f, 0.75f, 0.75f, .2f);
        ...
        static Assets()
        {
            var techlevels = Enum.GetValues(typeof(TechLevel)).Cast<TechLevel>().ToList();
            techlevels.Remove(TechLevel.Undefined);
